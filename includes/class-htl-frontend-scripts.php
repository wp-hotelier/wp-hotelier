...
class HTL_Frontend_Scripts {
	...
	public function frontend_scripts() {
		...
		$datepicker_params = array(
			...
			'i18n'               => array(
				'selected'          => _x( 'Your stay:', 'datepicker_selected', 'wp-hotelier' ),
				'night'             => _x( 'Night', 'datepicker_night', 'wp-hotelier' ),
				'nights'            => _x( 'Nights', 'datepicker_nights', 'wp-hotelier' ),
				'button'            => _x( 'Close', 'datepicker_apply', 'wp-hotelier' ),
				'clearButton'       => _x( 'Clear', 'datepicker_apply', 'wp-hotelier' ),
				'submitButton'      => _x( 'Check', 'datepicker_apply', 'wp-hotelier' ),
				'checkin-disabled'  => _x( 'Check-in disabled', 'datepicker_checkin_disabled', 'wp-hotelier' ),
				'checkout-disabled' => _x( 'Check-out disabled', 'datepicker_checkout_disabled', 'wp-hotelier' ),
				'day-names'         => $day_names,
				'day-names-short'   => $day_names_short,
				'month-names'       => $month_names,
				'month-names-short' => $month_names_short,
				'error-more'        => _x( 'Date range should not be more than 1 night', 'datepicker_error_more', 'wp-hotelier' ),
				'error-more-plural' => _x( 'Date range should not be more than %d nights', 'datepicker_error_more_plural', 'wp-hotelier' ),
				'error-less'        => _x( 'Date range should not be less than 1 night', 'datepicker_error_less', 'wp-hotelier' ),
				'error-less-plural' => _x( 'Date range should not be less than %d nights', 'datepicker_error_less_plural', 'wp-hotelier' ),
				'info-more'         => _x( 'Please select a date range longer than 1 night', 'datepicker_info_more', 'wp-hotelier' ),
				'info-more-plural'  => _x( 'Please select a date range longer than %d nights', 'datepicker_info_more_plural', 'wp-hotelier' ),
				'info-range'        => _x( 'Please select a date range between %d and %d nights', 'datepicker_info_range', 'wp-hotelier' ),
				'info-range-equal'  => _x( 'Please select a date range of %d nights', 'datepicker_info_range', 'wp-hotelier' ),
				'info-default'      => _x( 'Please select a date range', 'datepicker_info_default', 'wp-hotelier' ),
				'aria-application'      => _x( 'Calendar', 'datepicker_aria_application', 'wp-hotelier' ),
				'aria-selected-checkin'      => _x( 'Selected as check-in date, %s', 'datepicker_aria_selected_checkin', 'wp-hotelier' ),
				'aria-selected-checkout'      => _x( 'Selected as check-out date, %s', 'datepicker_aria_selected_checkout', 'wp-hotelier' ),
				'aria-selected'      => _x( 'Selected, %s', 'datepicker_aria_selected', 'wp-hotelier' ),
				'aria-disabled'      => _x( 'Not available, %s', 'datepicker_aria_disabled', 'wp-hotelier' ),
				'aria-choose-checkin'      => _x( 'Choose %s as your check-in date', 'datepicker_aria_choose_checkin', 'wp-hotelier' ),
				'aria-choose-checkout'      => _x( 'Choose %s as your check-out date', 'datepicker_aria_choose_checkout', 'wp-hotelier' ),
				'aria-prev-month'      => _x( 'Move backward to switch to the previous month', 'datepicker_aria_prev_month', 'wp-hotelier' ),
				'aria-next-month'      => _x( 'Move forward to switch to the next month', 'datepicker_aria_next_month', 'wp-hotelier' ),
				'aria-close-button'      => _x( 'Close the datepicker', 'datepicker_aria_close_button', 'wp-hotelier' ),
				'aria-clear-button'      => _x( 'Clear the selected dates', 'datepicker_aria_clear_button', 'wp-hotelier' ),
				'aria-submit-button'      => _x( 'Submit the form', 'datepicker_aria_submit_button', 'wp-hotelier' ),
			)
		);
		...
		wp_register_script( 'hotel-datepicker', HTL_PLUGIN_URL . 'assets/js/lib/hotel-datepicker/hotel-datepicker.min.js', array( 'fecha' ), '4.7.4', true );
