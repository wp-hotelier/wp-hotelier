...
<div class="htl-ui-setting htl-ui-setting--percentage htl-ui-setting--<?php echo esc_attr( $args[ 'id' ] ); ?>">
	...
	<label class="htl-ui-label htl-ui-label--text htl-ui-setting__description htl-ui-setting__description--percentage htl-ui-setting__description--<?php echo esc_attr( $args[ 'id' ] ); ?>" for="hotelier_settings[<?php echo esc_attr( $args[ 'id' ] ); ?>]"><?php echo wp_kses_post( $args[ 'desc' ] ); ?></label>
</div>
