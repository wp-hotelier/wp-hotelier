...
<div class="htl-ui-toolbar htl-ui-toolbar--variations <?php echo esc_attr( $position ); ?>">
	<span class="htl-ui-text-icon htl-ui-text-icon--collapse-variation"><?php esc_html_e( 'Close all', 'wp-hotelier' ); ?></span>

	<span class="htl-ui-text-icon htl-ui-text-icon--expand-variation"><?php esc_html_e( 'Expand all', 'wp-hotelier' ); ?></span>
