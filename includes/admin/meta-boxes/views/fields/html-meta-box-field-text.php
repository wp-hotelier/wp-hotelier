...
<div class="htl-ui-setting htl-ui-setting--metabox htl-ui-setting--text htl-ui-setting--<?php echo esc_attr( $field[ 'name' ] ); ?> <?php echo esc_attr( $field[ 'wrapper_class' ] ); ?> htl-ui-layout htl-ui-layout--two-columns">
	...
	<div class="htl-ui-layout__column htl-ui-layout__column--right">
		<input type="text" class="<?php echo esc_attr( $field[ 'class' ] ); ?> htl-ui-input htl-ui-input--text" name="<?php echo esc_attr( $field[ 'name' ] ); ?>" value="<?php echo esc_attr( $field_value ); ?>" placeholder="<?php echo esc_attr( $field[ 'placeholder' ] ); ?>" />
