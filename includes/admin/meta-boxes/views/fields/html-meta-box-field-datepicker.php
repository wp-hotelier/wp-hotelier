...
<div class="htl-ui-setting htl-ui-setting--metabox htl-ui-setting--datepicker <?php echo esc_attr( $field[ 'wrapper_class' ] ); ?> htl-ui-layout htl-ui-layout--two-columns">
	...
	<div class="htl-ui-layout__column htl-ui-layout__column--right">
		<span class="htl-ui-datepicker-wrapper">
			<input class="htl-ui-input htl-ui-input--datepicker <?php echo esc_attr( $field[ 'class' ] ); ?>" type="text" placeholder="YYYY-MM-DD" name="<?php echo esc_attr( $field[ 'name' ] ); ?>" value="<?php echo esc_attr( $field_value ); ?>" autocomplete="off">
		</span>
		...
		<?php if ( ! empty( $field[ 'description' ] ) ) : ?>
			<div class="htl-ui-setting__description htl-ui-setting__description--datepicker"><?php echo wp_kses_post( $field[ 'description' ] ); ?></div>
		<?php endif; ?>
	</div>
</div>
