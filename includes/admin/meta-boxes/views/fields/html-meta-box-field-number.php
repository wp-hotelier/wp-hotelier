...
<div class="htl-ui-setting htl-ui-setting--metabox htl-ui-setting--number htl-ui-setting--<?php echo esc_attr( $field[ 'name' ] ); ?> <?php echo esc_attr( $field[ 'wrapper_class' ] ); ?> htl-ui-layout htl-ui-layout--two-columns">
	...
	<div class="htl-ui-layout__column htl-ui-layout__column--right">
		...
		<?php if ( ! empty( $field[ 'description' ] ) ) : ?>
			<div class="htl-ui-setting__description htl-ui-setting__description--number"><?php echo wp_kses_post( $field[ 'description' ] ); ?></div>
		<?php endif; ?>
	</div>
</div>
