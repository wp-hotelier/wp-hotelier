...
if ( htl_get_page_id( 'terms' ) > 0 ) : ?>
	...
	<p class="form-row form-row--booking-terms">
		...
		<label for="booking-terms" class="checkbox label--booking-terms"><?php printf( wp_kses_post( sprintf( __( 'I&rsquo;ve read and accept the <a href="%s" target="_blank">terms &amp; conditions</a>', 'wp-hotelier' ), esc_url( htl_get_page_permalink( 'terms' ) ) ) ) ); ?> <abbr class="required" title="<?php echo esc_attr__( 'required', 'wp-hotelier' ); ?>">*</abbr></label>
