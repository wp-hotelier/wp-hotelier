...
<ul class="reservation-details__list">
	<li class="reservation-details__item reservation-details__item--number">
		<span class="reservation-details__label reservation-details__label--number"><?php esc_html_e( 'Reservation number:', 'hotelier' ); ?></span>
	...
	<li class="reservation-details__item reservation-details__item--date">
		<span class="reservation-details__label reservation-details__label--date"><?php esc_html_e( 'Date:', 'hotelier' ); ?></span>
	...
	<li class="reservation-details__item reservation-details__item--checkin">
		<span class="reservation-details__label reservation-details__label--checkin"><?php esc_html_e( 'Check-in:', 'hotelier' ); ?></span>
	...
	<li class="reservation-details__item reservation-details__item--checkout">
		<span class="reservation-details__label reservation-details__label--checkout"><?php esc_html_e( 'Check-out:', 'hotelier' ); ?></span>
	...
	<li class="reservation-details__item reservation-details__item--nights">
		<span class="reservation-details__label reservation-details__label--nights"><?php esc_html_e( 'Nights:', 'hotelier' ); ?></span>
	...
	<li class="reservation-details__item reservation-details__item--special-requests">
		<strong class="reservation-details__label reservation-details__label--special-requests"><?php esc_html_e( 'Special requests:', 'hotelier' ); ?></strong>
		<span class="reservation-details__data reservation-details__data--special-requests"><?php echo esc_html( $reservation->get_guest_special_requests() ? $reservation->get_guest_special_requests() : esc_html__( 'None', 'hotelier' ) ); ?></span>
	</li>
</ul>
