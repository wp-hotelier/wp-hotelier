...
echo sprintf( esc_html__( 'Telephone: %s.', 'hotelier' ), HTL_Info::get_hotel_telephone() ) . "\n";
echo sprintf( esc_html__( 'Fax: %s.', 'hotelier' ), HTL_Info::get_hotel_fax() ) . "\n";
echo sprintf( esc_html__( 'Email: %s.', 'hotelier' ), HTL_Info::get_hotel_email() ) . "\n\n";
