<?php
/**
 * Admin cancelled reservation email (plain text)
 *
 * This template can be overridden by copying it to yourtheme/hotelier/emails/plain/admin-cancelled-reservation.php
 *
